...
const MusicItemIcon = (props) => {
  return (
    ...
    <a href={props.url} target="_blank" rel="noopener noreferrer">
      ...
      <img className={`music-item__icon-image music-item__icon-image_highlighted ${props.className}`} alt={`${props.platform}-highlighted`} src={require(`./${props.platform}-icon-blah.png`)} />
    </a>
    </div>
  )
}
